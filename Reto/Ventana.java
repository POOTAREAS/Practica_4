...
public class Ventana extends JFrame {
    ...
    public Ventana(Mensajes controlador,Punto primero,Punto segundo,Punto tercero) {
        ...
        String equilatero = 
        (Math.abs(distancia1y2 - distancia1y3) < EPSILON &&
        Math.abs(distancia1y2 - distancia2y3) < EPSILON)
        ? "Si es equilatero" 
        : "No es equilatero";
        ...
        boton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                controlador.mensajeDistancia1y2() + distancia1y2 + "\n" + 
                controlador.mensajeDistancia2y3() + distancia2y3 + "\n" + 
                controlador.mensajeDistancia1y3() + distancia1y3 + "\n" +
                equilatero
                );
            }
        });
